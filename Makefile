...
.PHONY: all bintoc paltool tileimagetool tilesettool assetstool  wavtoraw xgmtool

all: info bintoc paltool tileimagetool tilesettool assetstool wavtoraw xgmtool
...
info:
	...
	@echo "        ASSETSTOOL_VER $(ASSETSTOOL_VER)"
